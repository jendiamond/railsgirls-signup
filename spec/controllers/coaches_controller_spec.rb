...
RSpec.describe CoachesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Coach" do
        expect {
          post :create, params: {coach: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved coach as @coach" do
        post :create, params: {coach: invalid_attributes}, session: valid_session
        expect(assigns(:coach)).to be_a_new(Coach)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested coach" do
        coach = Coach.create! valid_attributes
        put :update, params: {id: coach.to_param, coach: new_attributes}, session: valid_session
        coach.reload
      ...
      it "assigns the requested coach as @coach" do
        coach = Coach.create! valid_attributes
        put :update, params: {id: coach.to_param, coach: valid_attributes}, session: valid_session
        expect(assigns(:coach)).to eq(coach)
      end
    ...
    context "with invalid params" do
      it "assigns the coach as @coach" do
        coach = Coach.create! valid_attributes
        put :update, params: {id: coach.to_param, coach: invalid_attributes}, session: valid_session
        expect(assigns(:coach)).to eq(coach)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested coach" do
      coach = Coach.create! valid_attributes
      expect {
        delete :destroy, params: {id: coach.to_param}, session: valid_session
      }.to change(Coach, :count).by(-1)
    end
