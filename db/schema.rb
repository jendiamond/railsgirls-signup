...
ActiveRecord::Schema.define(version: 20200926073328) do
  ...
  create_table "coaches", force: :cascade do |t|
    ...
    t.string   "phone"
    t.string   "spokeo"
    t.boolean  "coach_april_13_pivotal"
    t.boolean  "coach_march_14_invpasadena"
    t.boolean  "coach_april_15_pivotal"
